...
ax1.set_xticks(range(5, 52, 5))  # Set x-axis ticks every 5 steps from 5 to 50
...
ax2.set_xticks(range(5, 52, 5))  # Set x-axis ticks every 5 steps from 5 to 50
...
# Save plots
plt.savefig(r'paperwork\3-最后50步里的动作值以及振动位移以及风速（逐渐递增的风速）\picture\last_episode_analysis.png', dpi=600, bbox_inches='tight')
plt.savefig(r'paperwork\3-最后50步里的动作值以及振动位移以及风速（逐渐递增的风速）\picture\last_episode_analysis.svg', format='svg', bbox_inches='tight')
