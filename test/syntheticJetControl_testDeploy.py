...
#这里的interval就是每次射流持续的时间
#目前case一个合成射流工作时间14.2秒 一个step14.3秒
def apply_voltage_sequence(voltage_sequence, interval=14.2):
    for voltage in voltage_sequence:
        set_signal_generator(voltage, modulation_frequency=6)  # Assuming modulation_frequency is fixed at 3
...
if __name__ == '__main__':
    ...
    voltage_sequence=load_voltage_sequence_from_csv(r'D:\Research\PHDProject\Code\Code_running\大风洞的合成射流DRL训练\Year2025\2-dutyratio20250525\test\save\1\trajlast100steps.csv')
