...
model = SAC.load(r"D:\Research\PHDProject\Code\Code_running\大风洞的合成射流DRL训练\Year2025\2-dutyratio20250525\test\logs_norm\rl_model_norm_14000_steps.zip".format(num),env = env)
