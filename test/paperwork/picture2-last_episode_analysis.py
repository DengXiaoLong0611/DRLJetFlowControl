...
# Read data
log_file = r'D:\Research\PHDProject\Code\Code_running\大风洞的合成射流DRL训练\Year2025\2-dutyratio20250525\test\save\1\DRLlog.txt'
log_file1 = r'D:\Research\PHDProject\Code\Code_running\大风洞的合成射流DRL训练\Year2025\2-dutyratio20250525\backup\2025-2-dutyratio-20250414\2025-2-dutyratio-test-coding\save\1\DRLlog.txt'
...
with open(log_file, 'r') as file:
    ...
    last_50_lines = lines[-100:]  # Get the last 50 lines
...
ax1.set_xticks(range(5, 100, 5))  # Set x-axis ticks every 5 steps from 5 to 50
ax1.set_xlim(0, 100)  # Set x-axis range from 1 to 50
...
ax2.set_xticks(range(5, 100, 5))  # Set x-axis ticks every 5 steps from 5 to 50
ax2.set_xlim(0, 100)  # Set x-axis range from 1 to 50
