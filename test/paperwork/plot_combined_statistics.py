...
# 读取数据
df = pd.read_csv('combined_episode_statistics.csv')
...
# 保存图片
plt.savefig('training_analysis_350episodes.png', dpi=300, bbox_inches='tight')
plt.savefig('training_analysis_350episodes.svg', format='svg', bbox_inches='tight')
