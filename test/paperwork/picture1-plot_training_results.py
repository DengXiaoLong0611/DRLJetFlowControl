...
# Add polynomial trend line (10th degree)
z = np.polyfit(filtered_episodes, filtered_rewards, 10)
p = np.poly1d(z)
plt.plot(filtered_episodes, p(filtered_episodes), "r--", alpha=0.8, label='Polynomial Trend Line (10th degree)')
